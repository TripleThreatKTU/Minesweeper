...
import static javaapplication1.Fr.*;
import static javaapplication1.Fr.one;
...
public class TCP implements Runnable {
 ...
 public static boolean minok=false;
 public static boolean ilgok=false;
   // Other constants
   public final static String statusMessages[] = {
      " Error! Could not connect!", " Disconnected",
      " Disconnecting...", " Connecting...", " Connected"
   };
   public static TCP tcpObj = new TCP();
   ...
   public static String hostIP = ipaddr();
...
public static DataOutputStream outToClient = null;
   ...
   private static JPanel initOptionsPane() {
      ...
      ipField = new JTextField(10); ipField.setText(ipaddr());
     ...
     //    chatLine.setEnabled(false);
      ...
      case CONNECTED:
          ...
          if(isHost&&cv){
              if(Fr.changed){
                   //cv=false;
                   sendString("m:"+ Integer.toString( m.getminos()));
               sendString("p:"+ Integer.toString( m.getilgis()));
              
                  
                  
              }if(!Fr.changed&&cv){
                   //cv=false;
                  sendString("m:"+ Integer.toString(10));
               sendString("p:"+ Integer.toString(9));
              }
            ...
            try {
               ...
               if (in.ready()) {
                  ...
                  String[] ss = s.split(":");
                    ...
                    if(!isHost&&ss[0].equals("p")){
                    
                      m.setilgis(Integer.valueOf(ss[1]));
                      ilgok=true;
                        
                      System.out.println("plotis "+ss[1]);
                      
                  }
                  if(!isHost&&ss[0].equals("m")){
                      
                      m.setminos(Integer.valueOf(ss[1]));
                minok=true;
                         
                      System.out.println("minos "+ss[1]);
                  }
